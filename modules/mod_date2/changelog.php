...
- html5 support?
- ajax method as well? (display initially with PHP for server time with option to update periodically)
...
Changelog
2.3.39 - 5 May 2013
Fix helper include path.

2.3 - 1 May 2013
Adjust the way DST / Summer Time works
Add DST / Summer Time adjust parameter
Add use local time parameter
Works with Joomla 2.5+
Escape characters in some fields
Merged some contributions from Dagoberto
Fix javascript aligning wrong
Add new generation method - Both will generate the date and time using PHP and then use Javascript to update it in real-time.
Other fixes
